...
groot = pygame.image.load('guardians_of_the_galaxy_vol_3_groot_png_by_metropolis_hero1125_dfuey0r-pre.png')
...
while run:
    ...
    # Draw Groot on the screen at the updated position
